...
class TimeSeriesApp:
    ...
    def plot_disch(self):
        ...
        plt.plot(self.datamet["datetime"], self.datamet["runoff_mm"], color="red", label="Obs.", linewidth=0.5)
        #  plt.plot(self.datares["datetime"], self.datares["q_mm"],marker=".", linestyle="-", color="blue", label="Sim.")
        plt.plot(self.datares["datetime"], self.datares["q_mm"], color="blue", label="Sim.", linewidth=0.5)
